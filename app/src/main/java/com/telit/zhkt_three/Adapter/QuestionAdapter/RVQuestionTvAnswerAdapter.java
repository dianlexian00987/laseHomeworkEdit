 ...
 */
public class RVQuestionTvAnswerAdapter extends RecyclerView.Adapter<RVQuestionTvAnswerAdapter.RVQuestionTvAnswerViewHolder> {
    private Context mContext;

    //0未提交  1 已提交  2 已批阅  作业的状态
     ...
     * 学段、学科、难易度以及题型
     */
    public void fetchNeedParam(String xd, String subjective, String difficulty, String questionType,String flag) {
        this.xd = xd;
        chid = subjective;
        this.difficulty = difficulty;
        type = questionType;
    ...
    public RVQuestionTvAnswerViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        return new RVQuestionTvAnswerViewHolder(LayoutInflater.from(mContext).inflate(R.layout.rv_total_question_item_layout,
                viewGroup, false));
    }
